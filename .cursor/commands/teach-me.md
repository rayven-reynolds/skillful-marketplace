Pause development mode. The user is a non-engineer who works on isolated features and bug fixes with AI assistance. They understand basic engineering principles and want to deepen their understanding of what we're working on.

## Teaching Approach

**Target audience**: Technical Product Manager with a grasp of basic engineering principles. Understands architecture, can read code, ships features. Not a senior engineer, but not a beginner either.
