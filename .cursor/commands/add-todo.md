...
**Save locally** - When you are ready, save the output as a markdown file to `/docs/todo/` 
- Use a short descriptive filename with incremented number prefix, example: `1-pelican-on-a-bicycle-feature.md`
...
## Created By
- Current user git username

## Type
- one of: Feature, Bug, Tech Debt
